...
static void main_window_load(Window *window) {
  ...
  seasick_the_cat_bmp_01 = gbitmap_create_with_resource(RESOURCE_ID_ANDERS_1);
  seasick_the_cat_bmp_02 = gbitmap_create_with_resource(RESOURCE_ID_ANDERS_2);
  seasick_the_cat_bmp_03 = gbitmap_create_with_resource(RESOURCE_ID_ANDERS_3);
  seasick_the_cat_bmp_04 = gbitmap_create_with_resource(RESOURCE_ID_ANDERS_4);
  seasick_the_cat_bmp_05 = gbitmap_create_with_resource(RESOURCE_ID_ANDERS_5);
  seasick_the_cat_bmp_06 = gbitmap_create_with_resource(RESOURCE_ID_ANDERS_6);
  seasick_the_cat_bmp_07 = gbitmap_create_with_resource(RESOURCE_ID_ANDERS_7);
  seasick_the_cat_bmp_08 = gbitmap_create_with_resource(RESOURCE_ID_ANDERS_8);
  seasick_the_cat_bmp_09 = gbitmap_create_with_resource(RESOURCE_ID_ANDERS_9);
  seasick_the_cat_bmp_10 = gbitmap_create_with_resource(RESOURCE_ID_ANDERS_10);
  seasick_the_cat_bmp_11 = gbitmap_create_with_resource(RESOURCE_ID_ANDERS_11);
